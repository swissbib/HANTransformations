...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   inkl. Leader und Kontrollfeldern-->
    ...
    <xsl:template match="marc:datafield">
        <xsl:for-each select=".">
            <xsl:choose>
                ...
                <xsl:when test="@tag='500' or @tag='592' or @tag='593' or @tag='594'">
                ...
                <xsl:when test="@tag='856'">
                    ...
                    <xsl:if test="@ind2='1'">
                      <xsl:call-template name="FREEHOL" />
                    </xsl:if>
                </xsl:when>
    ...
    <!--Template für die Verarbeitung von Feld 245 und 246-->
        ...
        <xsl:element name="{local-name()}">
            ...
            <xsl:attribute name="ind2">
                <xsl:choose>
                    ...
                    <!-- Nonfiling characters bei Feld 245-->
                    <xsl:otherwise>
                        <xsl:choose>
            ...
            <xsl:for-each select="marc:subfield">
                <xsl:choose>
                    ...
                    <xsl:when test="matches(@code, 'a|p')">
                        <xsl:element name="{local-name()}">
                            <xsl:for-each select="@*">
                                <xsl:copy-of select="."/>
                                <xsl:value-of select="replace(../text(), '&lt;|&gt;', '')"/>
   ...
   <!-- Template für FREE-Holding -->
   <xsl:template name="FREEHOL">
     <xsl:element name="datafield">
